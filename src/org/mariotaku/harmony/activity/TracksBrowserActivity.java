...
public class TracksBrowserActivity extends BaseActivity implements Constants {
	...
	private static final int URI_CODE_ALBUM = 1;
	private static final int URI_CODE_ARTIST = 2;

	private ActionBar mActionBar;

 
	static {
		URI_MATCHER.addURI(AUTHORITY_ALBUM, "*", URI_CODE_ALBUM);
		URI_MATCHER.addURI(AUTHORITY_ARTIST, "*", URI_CODE_ARTIST);
	}

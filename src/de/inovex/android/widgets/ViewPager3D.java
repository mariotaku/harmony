...
public class ViewPager3D extends ViewPager {
	...
	private void init(AttributeSet attrs) {
		...
		mOverscrollRotation = a.getFloat(R.styleable.ViewPager3D_overscrollRotation, DEFAULT_OVERSCROLL_ROTATION);
		mSwipeRotation = a.getFloat(R.styleable.ViewPager3D_swipeRotation, DEFAULT_SWIPE_ROTATION);
		mSwipeTranslation = a.getInt(R.styleable.ViewPager3D_swipeTranslation, DEFAULT_SWIPE_TRANSLATION);
		mOverscrollTranslation = a.getInt(R.styleable.ViewPager3D_overscrollTranslation, DEFAULT_OVERSCROLL_TRANSLATION);
		mOverscrollAnimationDuration = a.getInt(R.styleable.ViewPager3D_overscrollAnimationDuration, DEFAULT_OVERSCROLL_ANIMATION_DURATION);
		mAnimateAlpha = a.getBoolean(R.styleable.ViewPager3D_animateAlpha, DEFAULT_ANIMATE_ALPHA);
		a.recycle();
	}
